...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ref={ref}
    className={cn(
      `focus:bg-accent focus:text-accent-foreground "items-center "data-[disabled]:pointer-events-none relative flex w-full cursor-default rounded-sm py-1.5 pr-2 pl-8 text-sm outline-none select-none data-[disabled]:opacity-50`,
      className
    )}
    {...props}
  >
