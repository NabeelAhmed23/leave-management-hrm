...
>(({ className, inset, children, ...props }, ref) => (
  <DropdownMenuPrimitive.SubTrigger
    ref={ref}
    className={cn(
      "focus:bg-accent data-[state=open]:bg-accent flex cursor-default items-center gap-2 " +
        "rounded-sm px-2 py-1.5 text-sm outline-none select-none [&_svg]:pointer-events-none" +
  ...
  <DropdownMenuPrimitive.Item
    ...
    className={cn(
      "focus:bg-accent focus:text-accent-foreground relative flex cursor-default items-center " +
        "gap-2 rounded-sm px-2 py-1.5 text-sm transition-colors outline-none select-none" +
